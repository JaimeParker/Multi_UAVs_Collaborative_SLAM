    ...
    for(;;){
        ...
        switch(c){
            ...
            case KEYCODE_LEFT:
                ...
                ROS_INFO("Angular Speed is: %f rad/s", angular_z);
            ...
            case KEYCODE_UP:
                ...
                linear_z = linear_z + 0.02;
                if (linear_z > 1) linear_z = 1;
                ROS_INFO("Speed Z is: %f m/s", linear_z);
            ...
            case KEYCODE_W:
                ...
                ROS_INFO("Speed X is: %f m/s", linear_x);
            ...
            case KEYCODE_A:
                ...
                ROS_INFO("Speed Y is: %f m/s", linear_y);
                twist.linear.y = linear_y;
                flag = true;
                break;
            case KEYCODE_D:
                ROS_INFO("Command Dec flank speed RECEIVED!");
                linear_y = linear_y - 0.05;
                if (linear_y < -1) linear_y = -1;
                ROS_INFO("Speed Y is: %f m/s", linear_y);
                twist.linear.y = linear_y;
                flag = true;
